    ...
    <section class="max-w-7xl mx-auto px-4 py-8 md:py-12 lg:py-20">
        ...
        <div class="py-14">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                <!-- products overview -->
                <div class="flex flex-col bg-white border border-orange-100 shadow-sm rounded-xl dark:bg-slate-800 dark:border-orange-800">
                    <div class="p-4 md:p-5 flex justify-between gap-x-3">
                        ...
                        <div class="flex-shrink-0 flex justify-center items-center size-[46px] bg-red-600 text-white rounded-full dark:bg-red-800 dark:text-red-200">
                ...
                <div class="flex flex-col bg-white border shadow-sm border-orange-100 rounded-xl dark:bg-slate-800 dark:border-orange-800">
                    <div class="p-4 md:p-5 flex justify-between gap-x-3">
                        <div>
                            <p class="text-xs uppercase tracking-wide text-slate-500 dark:text-slate-400">
                                Purchased products
                        ...
                        <div class="flex-shrink-0 flex justify-center items-center size-[46px] bg-red-600 text-white rounded-full dark:bg-red-800 dark:text-blue-200">
                            <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
