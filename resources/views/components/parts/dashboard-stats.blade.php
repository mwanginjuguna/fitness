...
<div class="max-w-6xl py-6 mx-auto">
    <!-- Grid -->
    <div class="grid md:grid-cols-2 lg:grid-cols-4 border border-orange-200 shadow-sm rounded-xl overflow-hidden dark:border-orange-700">
        <!-- Users Card -->
        <a class="block p-4 md:p-5 relative bg-white hover:bg-gray-50 before:absolute before:top-0 before:start-0 before:w-full before:h-px md:before:w-px md:before:h-full before:bg-gray-200 before:first:bg-transparent dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:before:bg-neutral-800" href="">
            <div class="flex md:grid lg:flex gap-y-3 gap-x-5">
                ...
                <div class="grow">
                    ...
                    <h3 class="mt-1 text-xl sm:text-2xl font-semibold text-orange-600 dark:text-orange-500">
                    ...
                    <div class="mt-1 flex justify-between items-center">
                        ...
                        <span class="ms-1 inline-flex items-center gap-1.5 py-1 px-2 rounded-md text-xs font-medium bg-red-300 text-gray-800 dark:bg-red-600 dark:text-neutral-200">
